    ...
    shippingMethods: [
      {
        id: "royalmail",
        name: "Royal Mail",
        desc: "Royal Mail: 3-5 Working days",
        price: "10",
        type: "private"
      },
      {
      ...
      },
      {
        id: "parcelforce",
        name: "Parcelforce",
        desc: "Parcelforce: 2-3 Working days",
        price: "12",
        type: "company"
      }
    ],
...
new Vue({
  ...
  mounted: function() {
    var _self = this;
    getAddressAutocomplete.getAddressAutocomplete(
      document.getElementById("getaddress-autocomplete-input"),
      {
        select: function(selected) {
          _self.address = selected.data.address;
          _self.houseNumber = selected.data.houseNumber;
          _self.floor = selected.data.floor;
          _self.door = selected.data.door;
          _self.city = selected.data.city;
          _self.zip = selected.data.zip;
          _self.addressInput = selected.addressInput;
        }
      }
    );
  ...
  methods: {
    fetchData(event) {
      ...
      var _self = this;
      var apiURL = "https://api.getAddress.io/autocomplete/";
